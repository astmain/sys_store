...
// ==================== 入口函数 ====================
export function make_dto_obj({ list_path_file, path_file_write }: { list_path_file: string[], path_file_write: string }) {
    // ==================== 全局参数 ====================
    let dto_obj: any = {}
    ...
    // 写入文件
    // fs.writeFileSync('D:/BBB/sys_store/back1/src/parse444/dto_obj.json', JSON.stringify(dto_obj, null, 2))

    fs.writeFileSync(path_file_write, JSON.stringify(dto_obj, null, 2))
    return dto_obj
    // ==================== 工具函数:获取类名-开始 ====================
    /**
     * 获取类名
